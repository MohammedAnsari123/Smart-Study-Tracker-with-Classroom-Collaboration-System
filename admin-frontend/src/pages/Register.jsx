...
import { User, ShieldAlert, Mail, Lock, ArrowRight } from 'lucide-react';
    ...
    return (
        <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
            <div className="max-w-md w-full bg-white rounded-3xl shadow-xl p-8 border border-gray-100">
                ...
                <h2 className="text-3xl font-black text-center text-gray-900 mb-2">Create Admin</h2>
                <p className="text-gray-500 text-center font-medium placeholder:mb-8 text-sm">Register a new system administrator</p>
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                    ...
                    <p className="text-center text-sm font-medium text-gray-500 mt-6">
                        Already have an account? <Link to="/login" className="text-red-600 hover:text-red-500 font-bold">Sign In</Link>
                    </p>
                </form>
            </div>
        </div>
